 ...
 */
public class TencentIMRemoveFriendBuilder {
    ...
    public TencentIMRemoveFriendBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }

    public TencentIMRemoveFriendBuilder version(String version) {
        this.version = version;
        return this;
    }

    public TencentIMRemoveFriendBuilder sdkappid(Long sdkappid) {
        this.sdkappid = sdkappid;
        return this;
    }

    public TencentIMRemoveFriendBuilder identifier(String identifier) {
        this.identifier = identifier;
        return this;
    }

    public TencentIMRemoveFriendBuilder usersig(String usersig) {
